...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/queenkarina/Queen-Bot")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "QUEEN-BOT")
...
# Untuk Melihat Repo
REPO_NAME = os.environ.get("REPO_NAME") or "👸𝗤𝗨𝗘𝗘𝗡-𝗕𝗢𝗧👸"
...
DEFAULT_BIO = os.environ.get("DEFAULT_BIO") or "👸𝗤𝗨𝗘𝗘𝗡-𝗕𝗢𝗧👸"
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**👸𝗤𝗨𝗘𝗘𝗡-𝗕𝗢𝗧👸 v{BOT_VER} Sedang berjalan!**\n\n"
...
with bot:
    try:
        ...
        async def handler(event):
            ...
            text = (
                f"**Hey**, __I am using__  **👸𝗤𝗨𝗘𝗘𝗡-𝗕𝗢𝗧👸** \n\n"
            ...
            await tgbot.send_file(
                ...
                buttons=[
                    [
                        custom.Button.url(
                            text="👸 REPO QUEEN-BOT 👸",
                            url="https://github.com/queenkarina/Queen-Bot",
                        )
                    ],
                    [
                        custom.Button.url(
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@Ram_ubot"):
                ...
                result = builder.photo(
                    file=ramlogo,
                    link_preview=False,
                    text=f"**👸 inline Queen-Bot👸**\n\n⭐ **Owner** [Karina](t.me/whrhappines)\n✨ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository 👸Queen-Bot👸",
                    url="https://t.me/geezsupport",
                    text="**👸Queen-Bot👸**\n➖➖➖➖➖➖➖➖➖➖\n✨ **Owner :** [Karina](t.me/whrhappines)\n✨ **Support :** @geezsupport\n✨ **Repository :** [👸Queen-Bot👸](https://github.com/queenkarina/Queen-Bot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@Ram_ubot"):
                ...
                result = builder.article(
                    " 👸QUEEN-BOT👸 ",
                    text="""**👸QUEEN-BOT👸\n\n Anda Bisa Membuat QUEEN-BOT Anda Sendiri Dengan Cara:** __TEKEN DIBAWAH INI!__ 👇""",
                    buttons=[
                        [
                            custom.Button.url(
                                "👸Queen-Bot👸",
